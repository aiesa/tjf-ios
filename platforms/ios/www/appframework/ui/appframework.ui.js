 ...
 */
 /* global af*/
	...
	var windowhalfnegative = windowhalf * -1;
...
(function($) {
    ...
    var requiresJSFocus = $.os.ios||$.os.android; //devices which require .focus() on dynamic click events
...
//            this.scrollingDivs.menu_scroller.scrollToTop();
        ...
        launch: function() {
            ...
            var maskDiv = $.create("div", {
                id: "afui_mask",
                className: "ui-loader",
                html: "<span class='ui-icon ui-icon-loading spin'></span><h1></h1>"
            }).css({
                "z-index": 20000,
                display: "none"
            });
...
(function($) {
    ...
    function wire8Tiles() {
        ...
        $.ui.ready(function() {
            ...
            $.query("#afui #navbar footer").append("<a id='metroMenu' onclick='$.ui.toggleSideMenu()'>â€¢â€¢â€¢</a>");
